...
const en = {
  ...
  'erase.overwriteWarn': 'The original file will be modified in place. This cannot be undone.',
  'erase.keepBackup': 'Keep a backup of the original',
...
const zhCN: Record<keyof typeof en, string> = {
  ...
  'erase.overwriteWarn': '将就地修改原文件，此操作不可撤销。',
  'erase.keepBackup': '保留原文件备份',
